            ...
            ZStack {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        .animation(.easeIn(duration: 0.7).delay(2.7), value: animateViewIn)
                        ...
                        .animation(.easeIn(duration: 0.7).delay(2), value: animateViewIn)
                    ...
                    VStack {
                        if animateViewIn {
                            if !store.books.contains(.active) {
                                Text("No questions avaiable. Go to settings. ⬆️")
