                        ...
                        VStack {
                            if animateViewIn {
                                Image(systemName: "questionmark.app.fill")
                                    ...
                                    .rotationEffect(.degrees(hintWiggle ? -12 : -18))
                                    .padding()
                                    .padding(.leading, 20)
                                    ...
                                    if animateViewIn {
                                        if !tappedCorrectAnswer {
                                            Text(answer)
                                                ...
                                                .cornerRadius(25)
                                                .transition(.asymmetric(insertion: .scale, removal: .scale.combined(with: .opacity.animation(.easeOut(duration: 0.5)))))
                    ...
                    VStack {
                        if tappedCorrectAnswer {
                            Text("\(game.questionScore)")
                                .font(.largeTitle)
                                .padding(.top, 50)
                                .transition(.offset(y: -geo.size.width / 4))
